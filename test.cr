...
class Test
  ...
  def keyword_test(strvar, intvar, floatvar = 0.123, strvarkw : String = "nothing", boolvar : Bool = true, othervar : Test = Test.new(17))
...
MrbState.create do |mrb|
  ...
  MrbWrap.wrap_instance_method(mrb, Test, "bar", test_instance_method, [Int32, Bool, String, {Float32, 0.4}])
...
# TODO: Class/module functions with keyword arguments
